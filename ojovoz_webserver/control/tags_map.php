...
for($i=0;$i<sizeof($queryt);$i++) {
	...
	while($row=mysql_fetch_array($result,MYSQL_NUM)) {
		?><a href="remove_tag_map.php?id=<? echo($row[0]); ?>">remove</a> <? echo($row[1]); ?> <a href="tag_color.php?id=<? echo($row[0]); ?>"><img src="../includes/images/marker<? echo($row[2]); ?>_ball.png" align="absmiddle" border="0" title="click to change..."></a><br><?
	}
}
?></font></p>
